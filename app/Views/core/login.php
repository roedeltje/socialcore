...
// Handle form submission (POST) - Direct processing zonder AuthController
$errors = [];
$old_input = [];
$success_message = '';
    ...
    try {
        ...
        if (empty($errors)) {
            ...
            if ($result) {
                ...
                $errors['general'] = 'Ongeldige gebruikersnaam/e-mail of wachtwoord';
            }
        }
        ...
        error_log("Core login error: " . $e->getMessage());
        $errors['general'] = 'Er is een fout opgetreden. Probeer het later opnieuw.';
    }
}
